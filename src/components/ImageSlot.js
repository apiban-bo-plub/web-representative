...
export default function ImageSlot({ id, shape = 'rounded', radius = 12, fit = 'cover', placeholder, src, style, ...rest }) {
  ...
  const imageMap = {
    ...
    // Red Book sticky chapter reveal (home)
    'portal-rbook-1': '/images/red-book/red-book-closed-in-case.jpg',
    'portal-rbook-2': '/images/red-book/red-book-open-in-case.jpg',
    'portal-rbook-3': '/images/red-book/red-book-recipe-pages.jpg',
    // Provenance strip (home)
    'portal-prov-1': '/images/event/dried-herbs-in-ceramic-bowls.jpg',
    'portal-prov-2': '/images/event/grinding-herbs-pestle-mortar.jpg',
    'portal-prov-3': '/images/store/mixing-herbs-in-mortar.jpg',
    'portal-prov-4': '/images/store/balm-jars-ingredients-display.jpg',
    'portal-prov-5': '/images/store/ceramic-bowls-on-counter.jpg',
    'portal-prov-6': '/images/products/thepprasit-inhaler-jar-open.jpg',
    ...
    'apo-app-inhale': '/images/products/hands-holding-inhaler-and-oil.jpg',
    ...
    'heritage-guardian': '/images/store/founder-portrait.jpg',
